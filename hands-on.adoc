...
This is the documentation for https://github.com/nextflow-io/hack17/issues/2[Project 2^] of the Nexflow Hackaton 2017. This project will cover the implementation of a Variant Calling analisys pipeline for RNAseq data based on GATK best practices and using Nextflow as pipeline framework.
